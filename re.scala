...
def simpSEQ(r: Rexp) : Rexp = r match{
  ...
  case SEQ(r1,r2) => {
    val simp1 = simp(r1)
    val simp2 = simp(r2)
    if (simp1 == r1 && simp2 == r2){ 
    	SEQ(r1,r2)
    }
    else{
    	if (simp1 == ZERO || simp2 == ZERO || simp1 == ONE || simp2 == ONE){
    		simp(SEQ(simp1,simp2)) 
    	}
    	else {
    		SEQ(simp1,simp2)
    	}
...
def simpALT(r: Rexp) : Rexp = r match{
  ...
  case ALT(r1,r2) => {
    ...
    if (r1==r2) simp1 else {
      val simp2 = simp(r2)
      if (simp1 == simp2) simp1 else {
        if (simp1 == ZERO ||  simp2 == ZERO) simp(ALT(simp1,simp2)) else {
          ALT(simp1,simp2)
        }
      }
    }
...
def simp(r: Rexp) : Rexp = r match{
  ...
  case ALT(r1,ZERO) => simp(r1)
  case ALT(ZERO,r2) => simp(r2)
  case ALT(r1,r2) => simpALT(r)
  case SEQ(r1,ZERO) => ZERO
  case SEQ(ZERO,r2) => ZERO
  case SEQ(r1,ONE) => simp(r1)
  case SEQ(ONE,r2) => simp(r2)
  case SEQ(r1,r2) => simpSEQ(r)
  case STAR(d) => STAR(d)
}
